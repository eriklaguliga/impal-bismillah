	...
	<div class="container marketing">
		<div class ="row">
			<div class="col-lg-12">
				...
				<h2>Inventaris</h2>
				<p>Menyediakan berbagi program Peminjaman untuk peminjaman jenis inventaris di Tel-U seperti meja,kursi,dan lain-laiN.</p>
				<p><a class="btn btn-default" href="camping.php">Next &raquo;</a></p>
				</center>
			</div>
		</div>	
	</div>
